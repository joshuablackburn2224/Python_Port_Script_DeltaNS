...
# 2)Place script in folder with old config files
# 3)Drag script to command prompt 
# 4)Don't click CSV. Launch Excel go to "tell me what you want" and type import CSV and select do not detect data type
import re
